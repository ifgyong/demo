...
typedef CF_OPTIONS(CFOptionFlags, CFRunLoopActivity) {
    ...
    kCFRunLoopBeforeTimers = (1UL << 1),//进入处理timers
    kCFRunLoopBeforeSources = (1UL << 2), //进入处理sourcs
    kCFRunLoopBeforeWaiting = (1UL << 5),//进入等待
    kCFRunLoopAfterWaiting = (1UL << 6),//进入干活了
    kCFRunLoopExit = (1UL << 7),//退出了
