...
function saveBundleAndMap(
    ...
    const
        ...
        bundleOutput =
            ...
            options.bundleOutput, encoding = options.bundleEncoding, dev = options.dev,
        sourcemapOutput = options.sourcemapOutput, sourcemapSourcesRoot = options.sourcemapSourcesRoot;
    ...
    const writeMetadata = writeFile(
        ...
        meta(code, encoding),
        'binary');
    Promise.all([writeBundle, writeMetadata]).then(() = > log('Done writing bundle output')
)
    ;
