...
var _require =
    ...
    require('path');
const joinPath = _require.join, relativePath = _require.relative, extname = _require.extname;
...
class Module {
    ...
    constructor(_ref) {
        let depGraphHelpers = _ref.depGraphHelpers, localPath = _ref.localPath, file = _ref.file,
            getTransformCacheKey = _ref.getTransformCacheKey, globalTransformCache = _ref.globalTransformCache,
            moduleCache = _ref.moduleCache, options = _ref.options, reporter = _ref.reporter,
    ...
    getCode(transformOptions) {
        ...
        return this.read(transformOptions).then((_ref2) = > {let code = _ref2.code;
        return code;
    })
        ;
    }
    ...
    getMap(transformOptions) {
        /* $FlowFixMe(>=0.54.0 site=react_native_fb) This comment suppresses an
                                 * error found when Flow v0.54 was deployed. To see the error delete this
                                 * comment and run Flow. */
        return this.read(transformOptions).then((_ref3) = > {let map = _ref3.map;
        return map;
    })
        ;
    }
    ...
    getDependencies(transformOptions) {
        /* $FlowFixMe(>=0.54.0 site=react_native_fb) This comment suppresses an
                                          * error found when Flow v0.54 was deployed. To see the error delete this
                                          * comment and run Flow. */
        return this.read(transformOptions).then((_ref4) = > {let dependencies = _ref4.dependencies;
        return dependencies;
    })
        ;
    }
