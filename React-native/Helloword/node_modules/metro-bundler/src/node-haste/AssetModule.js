...
class AssetModule extends Module {
    ...
    constructor(
        ...
        platforms) {
        super(args);
        var _AssetPaths$parse =
            AssetPaths.parse(this.path, platforms);
        const resolution = _AssetPaths$parse.resolution, name = _AssetPaths$parse.name, type = _AssetPaths$parse.type;
