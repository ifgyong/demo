...
class ResolutionResponse {
    ...
    copy(properties) {
        ...
        const dependencies = _properties$dependenc === undefined ? this.dependencies : _properties$dependenc;
        var _properties$mainModul = properties.mainModuleId;
        const mainModuleId = _properties$mainModul === undefined ? this.mainModuleId : _properties$mainModul;
        var _properties$mocks = properties.mocks;
        const mocks = _properties$mocks === undefined ? this.mocks : _properties$mocks;
