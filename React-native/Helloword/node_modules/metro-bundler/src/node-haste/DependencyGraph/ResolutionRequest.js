...
class ResolutionRequest {
    ...
    getOrderedDependencies(_ref) {
        let response = _ref.response, transformOptions = _ref.transformOptions, onProgress = _ref.onProgress;
        var _ref$recursive = _ref.recursive;
        let recursive = _ref$recursive === undefined ? true : _ref$recursive;
    ...
    >
        ...
        return module.readFresh(transformOptions).then((_ref2) = > {let dependencies = _ref2.dependencies;
        return (
        ...
        ;
        const crawlDependencies = (mod, _ref3) =
    >
        {
            var _ref4 = _slicedToArray(_ref3, 2);
            let depNames = _ref4[0], dependencies = _ref4[1];
            const filteredPairs = [];
            ...
            const dependencyModules = filteredPairs.map((_ref5) = > {var _ref6 = _slicedToArray(_ref5, 2);
            let m = _ref6[1];
            return m;
        })
            ;
        ...
        function resolveKeyWithPromise(_ref7) {
            ...
            let key = _ref8[0], promise = _ref8[1];
        ...
        return Promise.all([
            ...
            collectionsInProgress.done]).then((_ref9) = > {var _ref10 = _slicedToArray(_ref9, 1);
        let rootDependencies = _ref10[0];
        return Promise.all(
            Array.from(collectedDependencies, resolveKeyWithPromise)).then(moduleToDependenciesPairs = > [
            rootDependencies,
        ...
        then((_ref11) = > {var _ref12 = _slicedToArray(_ref11, 2);
        let rootDependencies = _ref12[0], moduleDependencies = _ref12[1];
