...
class Resolver {
    ...
    getDependencies(
        ...
        return _asyncToGenerator(function* () {
            ...
            var _options$recursive = options.recursive;
            const recursive = _options$recursive === undefined ? true : _options$recursive,
                prependPolyfills = options.prependPolyfills;
            ...
            if (prependPolyfills) {
                _this._getPolyfillDependencies(platform).reverse().forEach(function (polyfill) {
    ...
    getModuleSystemDependencies(_ref) {
        ...
        let dev = _ref$dev === undefined ? true : _ref$dev;
        const prelude = dev ?
    ...
    resolveRequires(
        ...
        for (const _ref2 of dependencyPairs) {
        ...
        return dependencyOffsets.reduceRight(
            (_ref4, offset) = > {var _ref5 = _slicedToArray(_ref4, 2);
        let unhandled = _ref5[0], handled = _ref5[1];
        return [
    ...
    wrapModule(_ref6) {
        let module = _ref6.module, getModuleId = _ref6.getModuleId, dependencyPairs = _ref6.dependencyPairs,
            dependencyOffsets = _ref6.dependencyOffsets, name = _ref6.name, map = _ref6.map, code = _ref6.code;
        var _ref6$dev = _ref6.dev;
        let dev = _ref6$dev === undefined ? true : _ref6$dev;
        if (module.isJSON()) {
...
function defineModuleCode(moduleName, code) {
    let verboseName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
    let dev = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    return [
        `__d(/* ${verboseName} */`,
...
function replaceDependencyID(stringWithDependencyIDAtStart, resolvedDeps) {
    ...
    if (match != null && dependencyName in resolvedDeps) {
        ...
        return (
            padRight(id, length) +
            stringWithDependencyIDAtStart.slice(length).replace(/$/m, ` // ${id} = ${dependencyName}`));
