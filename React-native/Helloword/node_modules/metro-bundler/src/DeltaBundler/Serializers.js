 ...
 */let deltaBundle = (() = > {
    var _ref = _asyncToGenerator(
        function* (
            ...
            const id = _ref2.id, delta = _ref2.delta;


            function stringifyModule(_ref3) {
                var _ref4 = _slicedToArray(_ref3, 2);
                let id = _ref4[0], module = _ref4[1];
...
return function deltaBundle(_x, _x2) {
...
let fullSourceMap = (() = > {
    var _ref5 = _asyncToGenerator(
        function* (
            ...
            const id = _ref6.id, delta = _ref6.delta;
...
return function fullSourceMap(_x3, _x4) {
...
let fullSourceMapObject = (() = > {
    var _ref7 = _asyncToGenerator(
        function* (
            ...
            const id = _ref8.id, delta = _ref8.delta;
...
return function fullSourceMapObject(_x5, _x6) {
 ...
 */let fullBundle = (() = > {
    var _ref9 = _asyncToGenerator(
        function* (
            ...
            const id = _ref10.id, delta = _ref10.delta;


            const deltaPatcher = DeltaPatcher.get(id).applyDelta(delta);
            const code = deltaPatcher.getAllModules().map(function (m) {
                return m.code;
            });
...
return function fullBundle(_x7, _x8) {
...
let getAllModules = (() = > {
    var _ref11 = _asyncToGenerator(
        function* (
            ...
            const id = _ref12.id, delta = _ref12.delta;


            return DeltaPatcher.get(id).applyDelta(delta).getAllModules();
        });
return function getAllModules(_x9, _x10) {
        ...
        function* (
            ...
            var _ref14 =
                yield deltaBundler.getDeltaTransformer(
                    options);
            const deltaTransformer = _ref14.deltaTransformer, id = _ref14.id;
...
return function _build(_x11, _x12) {
...
var _require = require('../Bundler/source-map');
