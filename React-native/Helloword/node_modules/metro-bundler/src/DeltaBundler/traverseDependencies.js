...
return function traverseDependencies(_x, _x2, _x3, _x4) {
...
return function initialTraverseDependencies(_x6, _x7, _x8, _x9) {
...
let traverseDependenciesForSingleFile = (() = > {
    var _ref3 = _asyncToGenerator(
        function* (
            ...
            const deleted = Array.from(edge.dependencies.entries()).map(function (_ref4) {
                var _ref5 = _slicedToArray(_ref4, 2);
                let relativePath = _ref5[0], absolutePath = _ref5[1];
            ...
            const added = yield Promise.all(
                Array.from(
                    ...
                    var _ref6 = _asyncToGenerator(function* (_ref7) {
                        ...
                        let absolutePath = _ref8[0], relativePath = _ref8[1];
                        let newDependencies;
...
return function traverseDependenciesForSingleFile(_x11, _x12, _x13, _x14) {
    ...
    return new Map(
        dependencies.map(relativePath = > [
            dependencyGraph.resolveDependency(
                parentModule,
                relativePath,
                transformOptions.platform).path,
            relativePath])
)
    ;
