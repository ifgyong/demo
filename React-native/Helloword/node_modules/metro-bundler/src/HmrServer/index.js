...
class HmrServer {
    ...
    onClientConnect(
        ...
        return _asyncToGenerator(function* () {
            var _querystring$parse =
                querystring.parse(
                    /* $FlowFixMe: url might be null */
                    url.parse(clientUrl).query);
            const bundleEntry = _querystring$parse.bundleEntry, platform = _querystring$parse.platform;
            ...
            const deltaTransformer = _ref.deltaTransformer;
    ...
    _prepareResponse(client) {
        ...
        return _asyncToGenerator(function* () {
            ...
            for (const _ref2 of result.delta) {
                var _ref3 = _slicedToArray(_ref2, 2);
                const id = _ref3[0];
                const module = _ref3[1];
