...
var _require =
    ...
    require('./util');
const LazyPromise = _require.LazyPromise, LockingPromise = _require.LockingPromise;
var _require2 =
...
>
    child.then(() = > connectAndSendJob(socket, message(stack, sourceMaps))
).
...
function startupChild(socket) {
    ...
    return new Promise((resolve, reject) = > {
        child.
            once('error', reject).once('message', () = > {
