...
var _require2 =
    ...
    require('path');
const pathSeparator = _require2.sep, joinPath = _require2.join, pathDirname = _require2.dirname,
...
var _require3 =
    ...
    require('../Logger');
const createActionStartEntry = _require3.createActionStartEntry, createActionEndEntry = _require3.createActionEndEntry,
    log = _require3.log;
const
...
class Bundler {
    ...
    constructor(opts) {
        ...
        const transformModuleHash = crypto.createHash('sha1').update(transformModuleStr).digest('hex');
    ...
    >
        ...
        const transformCacheKey = crypto.createHash('sha1').update(cacheKeyParts.join('$')).digest('hex');
    ...
    bundle(options) {
        ...
        return this._resolverPromise.then(resolver = > resolver.getModuleSystemDependencies({dev, unbundle})
    ).
    ...
    _bundle(_ref) {
        let assetPlugins = _ref.assetPlugins, bundle = _ref.bundle, dev = _ref.dev, entryFile = _ref.entryFile,
            entryModuleOnly = _ref.entryModuleOnly, generateSourceMaps = _ref.generateSourceMaps, hot = _ref.hot,
            isolateModuleIDs = _ref.isolateModuleIDs, minify = _ref.minify;
        ...
        let moduleSystemDeps = _ref$moduleSystemDeps === undefined ? [] : _ref$moduleSystemDeps,
            onProgress = _ref.onProgress, platform = _ref.platform, resolutionResponse = _ref.resolutionResponse,
            runBeforeMainModule = _ref.runBeforeMainModule, runModule = _ref.runModule, unbundle = _ref.unbundle;
    ...
    >
        {
            let
                ...
                modulesByPath = _ref2.modulesByPath;
            return (


                this._resolverPromise.then(resolver = >
                Promise.all(
                    transformedModules.map((_ref3) = > {let module = _ref3.module, transformed = _ref3.transformed;
            return (
        ...
        :
            ...
            then(runBeforeMainModules = > {
                runBeforeMainModules = runBeforeMainModules.map(module = > modulesByPath[module.path]
        ).
            filter(Boolean);
    ...
    _buildBundle(_ref4) {
        let entryFile = _ref4.entryFile, dev = _ref4.dev, minify = _ref4.minify, platform = _ref4.platform,
            bundle = _ref4.bundle, hot = _ref4.hot, unbundle = _ref4.unbundle,
            resolutionResponse = _ref4.resolutionResponse, isolateModuleIDs = _ref4.isolateModuleIDs,
            generateSourceMaps = _ref4.generateSourceMaps, assetPlugins = _ref4.assetPlugins;
        ...
        return Promise.all([
            ...
            resolutionResponse]).then((_ref5) = > {var _ref6 = _slicedToArray(_ref5, 2);
        let resolver = _ref6[0], response = _ref6[1];
    ...
    >
        ...
        const postProcess = p ?
            modules =
    >
        p(modules, entryFile, {dev, minify, platform})
    :
        null;

        return Promise.all(response.dependencies.map(toModuleTransport)).then(postProcess).then(moduleTransports = > {
    ...
    getShallowDependencies(_ref7) {
        var _this = this;
        let entryFile = _ref7.entryFile, rootEntryFile = _ref7.rootEntryFile, platform = _ref7.platform;
        ...
        let generateSourceMaps = _ref7$generateSourceM === undefined ? false : _ref7$generateSourceM,
            transformerOptions = _ref7.transformerOptions;
        return _asyncToGenerator(function* () {
            ...
            return _this._resolverPromise.then(function (resolver) {
                return (
    ...
    getDependencies(_ref8) {
        var _this2 = this;
        let entryFile = _ref8.entryFile, platform = _ref8.platform;
        ...
        let isolateModuleIDs = _ref8$isolateModuleID === undefined ? false : _ref8$isolateModuleID,
            rootEntryFile = _ref8.rootEntryFile, prependPolyfills = _ref8.prependPolyfills,
    ...
    getOrderedDependencyPaths(_ref9) {
        let entryFile = _ref9.entryFile, dev = _ref9.dev, platform = _ref9.platform, minify = _ref9.minify,
    ...
    _toModuleTransport(_ref12) {
        let module = _ref12.module, bundle = _ref12.bundle, entryFilePath = _ref12.entryFilePath,
            options = _ref12.options, getModuleId = _ref12.getModuleId, dependencyPairs = _ref12.dependencyPairs,
        ...
        return module.read(transformOptions).then((_ref13) = > {
            let code = _ref13.code,
            dependencies = _ref13.dependencies,
            dependencyOffsets = _ref13.dependencyOffsets,
            map = _ref13.map,
    ...
    generateAssetObjAndCode(
        ...
        const code = _generateAssetTransfo.code, dependencies = _generateAssetTransfo.dependencies,
    ...
    _applyAssetPlugins(
        ...
        var _assetPlugins = _toArray(
            assetPlugins);
        const currentAssetPlugin = _assetPlugins[0], remainingAssetPlugins = _assetPlugins.slice(1);
        /* $FlowFixMe: dynamic requires prevent static typing :'(  */
    ...
    _generateAssetModule(
        ...
        return this.generateAssetObjAndCode(
            module,
            assetPlugins,
            platform).then((_ref14) = > {let asset = _ref14.asset, code = _ref14.code, meta = _ref14.meta;
...
function getMainModule(_ref15) {
    let dependencies = _ref15.dependencies;
    var _ref15$numPrependedDe = _ref15.numPrependedDependencies;
    let numPrependedDependencies = _ref15$numPrependedDe === undefined ? 0 : _ref15$numPrependedDe;
