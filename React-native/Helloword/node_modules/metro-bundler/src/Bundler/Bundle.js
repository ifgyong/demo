...
const isMappingsMap = _require3.isMappingsMap;
...
class Bundle extends BundleBase {
    ...
    constructor() {
        ...
        let sourceMapUrl = _ref.sourceMapUrl, dev = _ref.dev, minify = _ref.minify, ramGroups = _ref.ramGroups,
            postProcessBundleSourcemap = _ref.postProcessBundleSourcemap;
        super();
    ...
    addModule(
        ...
        for (const _ref2 of dependencyPairs) {
            ...
            const dependencyModule = _ref3[1];
    ...
    getUnbundle() {
        ...
        if (!this._ramBundle) {
            ...
            var _partition = partition(modules, shouldPreload), _partition2 = _slicedToArray(_partition, 2);
            const startupModules = _partition2[0], lazyModules = _partition2[1];
    ...
    getEtag() {
        ...
        /* $FlowFixMe: we must pass options, or rename the
                           * base `getSource` function, as it does not actually need options. */.update(this.getSource()).digest('hex');
        return eTag;
    }
    ...
    getJSModulePaths() {
        return (
            ...
            // Filter out non-js files. Like images etc.
                .filter(module = > !module.virtual).map(module = > module.sourcePath
    ))
        ;
...
function* subtree(
    ...
    for (const _ref7 of meta.dependencyPairs || []) {
        var _ref8 = _slicedToArray(_ref7, 2);
        const path = _ref8[1].path;
