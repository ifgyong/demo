...
const AmbiguousModuleResolutionError = _require.AmbiguousModuleResolutionError;
...
class TerminalReporter {
    ...
    _getBundleStatusMessage(_ref,
                            phase) {
        let bundleOptions = _ref.bundleOptions, transformedFileCount = _ref.transformedFileCount,
            totalFileCount = _ref.totalFileCount, ratio = _ref.ratio;
    ...
    _updateBundleProgress(_ref2) {
        let buildID = _ref2.buildID, transformedFileCount = _ref2.transformedFileCount,
     ...
     */
    _getStatusMessage() {
        return [this._getDepGraphStatusMessage()].concat(
            Array.from(this._activeBundles.entries()).map((_ref3) = > {var _ref4 = _slicedToArray(_ref3, 2);
        let _ = _ref4[0], progress = _ref4[1];
        return (
