...
var _require2 =
    require('./util');
const getModuleCode = _require2.getModuleCode, concat = _require2.concat;


function asPlainBundle(_ref) {
    let filename = _ref.filename, idsForPath = _ref.idsForPath, modules = _ref.modules,
        requireCalls = _ref.requireCalls, sourceMapPath = _ref.sourceMapPath;
    let code = '';
    let line = 0;
    const sections = [];
    const modIdForPath = x =
>
