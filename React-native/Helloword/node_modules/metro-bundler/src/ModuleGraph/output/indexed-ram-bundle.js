...
var _require =
    ...
    require('../../Bundler/util');
const createRamBundleGroups = _require.createRamBundleGroups;
var _require2 =


    require('../../shared/output/unbundle/as-indexed-file');
const buildTableAndContents = _require2.buildTableAndContents, createModuleGroups = _require2.createModuleGroups;
var _require3 =
    require('./util');
const concat = _require3.concat, getModuleCode = _require3.getModuleCode, partition = _require3.partition,
    toModuleTransport = _require3.toModuleTransport;


function asIndexedRamBundle(_ref) {
    let filename = _ref.filename, idsForPath = _ref.idsForPath, modules = _ref.modules,
        preloadedModules = _ref.preloadedModules, ramGroupHeads = _ref.ramGroupHeads, requireCalls = _ref.requireCalls;
    const idForPath = x =
>
    idsForPath(x).moduleId;
    var _partition =
        partition(modules, preloadedModules), _partition2 = _slicedToArray(_partition, 2);
    const startup = _partition2[0], deferred = _partition2[1];
