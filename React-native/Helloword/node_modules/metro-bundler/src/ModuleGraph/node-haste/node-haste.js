...
>
{
    let files = _ref.files, helpers = _ref.helpers, moduleCache = _ref.moduleCache, sourceExts = _ref.sourceExts;
    const map = Object.create(null);
    files.forEach(filePath = > {
        if(
    !helpers.isNodeModulesDir(filePath)
)
    {
        let id;
        let module;
...
exports.createResolveFn = function (options) {
    const
        assetExts = options.assetExts, extraNodeModules = options.extraNodeModules,
        transformedFiles = options.transformedFiles, sourceExts = options.sourceExts;
