...
exports.create = function create(resolve, load) {
    let Graph = (() = > {
        var _ref = _asyncToGenerator(
            function* (entryPoints, platform, options) {
                var _ref2 =


                    options || NO_OPTIONS, _ref2$log = _ref2.log;
                const log = _ref2$log === undefined ? console : _ref2$log;
                var _ref2$optimize = _ref2.optimize;
                const optimize = _ref2$optimize === undefined ? false : _ref2$optimize, skip = _ref2.skip;
                ...
                const queue = new Queue(
                    function (_ref3) {
                        let id = _ref3.id, parent = _ref3.parent;
                        return memoizingLoad(resolve(id, parent, platform, options || NO_OPTIONS), loadOptions);
                    },
                    onFileLoaded,
                    new Map([[null, emptyModule()]]));


                const tasks = Array.from(entryPoints, function (id, i) {
                    return {
                        id,
                        parent: null,
    ...
    return function Graph(_x, _x2, _x3) {
...
class Queue {
    ...
    constructor(runTask, accumulate, initial) {
        ...
        var _deferred =
            ...
            deferred();
        const promise = _deferred.promise, reject = _deferred.reject, resolve = _deferred.resolve;
        this.result = promise;
        this._reject = reject;
...
function onFileLoaded(queue, modules, _ref4, _ref5) {
    let file = _ref4.file, dependencies = _ref4.dependencies;
    let id = _ref5.id, parent = _ref5.parent, parentDependencyIndex = _ref5.parentDependencyIndex, skip = _ref5.skip;
    const
        path = file.path;
...
function collect(
    modules) {
    let path = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    let serialized = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {
        entryModules: [],
        modules: []
    };
