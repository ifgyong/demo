...
const compactMapping = _require.compactMapping;
...
function transform(_ref) {
    let filename = _ref.filename, options = _ref.options, src = _ref.src;
    ...
    try {
        ...
        var _babel$transform =
            babel.transform(src, babelConfig);
        const ast = _babel$transform.ast, ignored = _babel$transform.ignored;
