...
it('should check for type', () = > {
    expect(Object.entries.bind(null, null)
).
toThrow(TypeError(
...
expect(Object.entries.bind(null, () = > {})
).
not.toThrow();
expect(Object.entries.bind(null, {})).not.toThrow();
