...
describe('deepFreezeAndThrowOnMutationInDev', function () {
    ...
    it('should be a noop on non object values', () = > {
        __DEV__ = true;
    expect(() = > deepFreezeAndThrowOnMutationInDev('')
).
    not.toThrow();
    expect(() = > deepFreezeAndThrowOnMutationInDev(null)
).
    not.toThrow();
    expect(() = > deepFreezeAndThrowOnMutationInDev(false)
).
    not.toThrow();
    expect(() = > deepFreezeAndThrowOnMutationInDev(5)
).
    not.toThrow();
    expect(() = > deepFreezeAndThrowOnMutationInDev()
).
    ...
    deepFreezeAndThrowOnMutationInDev(o);
    expect(() = > {o.key1.key2.key3 = 'newValue';
}).
    toThrowError(
