...
const _warningMap
:
Map < string, WarningInfo > = new Map();
...
boolean
{
    const isIgnored = IGNORED_WARNINGS.some((ignoredWarning
:
    string
)
    =
...
type
StackRowProps = {frame: StackFrame};
...
>
{
    ...
    if (stacktraceVisible && stacktrace) {
        ...
        style = {styles.inspectorCount} >
            < Text
        style = {styles.inspectorCountText} > {countSentence} < /Text>
            < TouchableHighlight
        ...
        style = {styles.inspectorWarning} >
            {stacktraceList}
            < Text
        style = {styles.inspectorWarningText} > {warning} < /Text>
            < /ScrollView>
            < View
        ...
        underlayColor = "transparent" >
            < Text
        style = {styles.inspectorButtonText} > Minimize < /Text>
            < /TouchableHighlight>
            < TouchableHighlight
        activeOpacity = {0.5}
        onPress = {onDismiss}
        ...
        underlayColor = "transparent" >
            < Text
        style = {styles.inspectorButtonText} > Dismiss < /Text>
            < /TouchableHighlight>
            < TouchableHighlight
        activeOpacity = {0.5}
        ...
        underlayColor = "transparent" >
            < Text
        style = {styles.inspectorButtonText} > Dismiss
        All < /Text>
        < /TouchableHighlight>
        < /View>
        < /SafeAreaView>
