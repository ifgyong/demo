    ...
    <script>
        ...
        (function () {
            ...
            function getBlobUrl(url) {
                ...
                return await
                window.deltaUrlToBlobUrl(url.replace('.bundle', '.delta'));
            }
        })();
    </script>
    <style type="text/css">
...
<div class="content">
    ...
    <p>Press <kbd id="shortcut" class="shortcut">⌘⌥I</kbd> to open Developer Tools. Enable <a
            href="https://stackoverflow.com/a/17324511/232122" target="_blank">Pause On Caught Exceptions</a> for a
        better debugging experience.</p>
    <p>You may also install <a href="https://github.com/facebook/react-devtools/tree/master/packages/react-devtools"
                               target="_blank">the standalone version of React Developer Tools</a> to inspect the React
        component hierarchy, their props, and state.</p>
